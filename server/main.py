...
from aistory.deepseek import get_tool, DeepSeek
from aistory.server import app
...
if __name__ == '__main__':
    ...
    # print(get_useful_wikis('Give me the category the item described below: A threadbare hood of coarse-spun wool, frayed at the edges and bleached by sun and rain. A long rent mars the brim—perhaps from a blade, perhaps from thorns. He does not recall.'))
    #
